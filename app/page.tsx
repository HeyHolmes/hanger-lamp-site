...
export default function Home() {
  ...
  return (
    <div className="font-sans select-none bg-[#E2DCDB]">
      {/* ========== SCROLLING MARQUEE BANNER ========== */}
      <div className={`fixed top-0 left-0 right-0 z-50 overflow-hidden py-2.5 transition-colors duration-500 ${
        isOff ? "bg-[#2a2a2a]/80 backdrop-blur-sm" : "bg-[#E2DCDB]/80 backdrop-blur-sm"
      }`}>
        <div
      ...
      <section id="visuals" className={`py-8 md:py-12 px-4 md:px-8 transition-colors duration-500 ${
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-4 md:auto-rows-[200px]">
          ...
          {/* Large final image */}
          <div className="md:col-span-12 md:row-span-2 relative overflow-hidden group h-64 md:h-auto">
            <Image
      ...
      <footer id="contact" className="bg-[#1a1a1a] text-white py-12 md:py-16 px-4 md:px-8">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
          ...
          <div>
            <h4 className="text-sm font-medium tracking-widest text-neutral-500 mb-4">SPECS</h4>
            <div className="space-y-2 text-sm">
              <a href="/images/HangerLamp_Spec_Sheet.pdf" download className="block text-neutral-400 hover:text-white transition-colors">Download PDF</a>
            </div>
          </div>
        </div>
